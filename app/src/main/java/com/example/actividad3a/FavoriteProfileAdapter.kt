...
class FavoriteProfileAdapter (private val mDataSet: List<game_content>, var onClick: (game_content) -> Unit) :
    ...
    inner class MainViewHolder(var v: View) : RecyclerView.ViewHolder(v) {
        ...
        val miFoto = v.findViewById<ImageView>(R.id.miImagenUsuario)
